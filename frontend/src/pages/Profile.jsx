        ...
        <div className="mx-20 flex flex-col gap-10 item-center min-h-screen p-14 ">
          ...
          <div className="grid grid-cols-3 lg:grid-cols-3 md:grid-cols-2 gap-4">
            <Link to={"/listings/view"}>
              <div className="bg-gray-100 p-4 rounded-xl shadow-md min-h-40 cursor-pointer hover:brightness-95 hover:shadow-lg transition-all duration-300">
            ...
            <Link to={"/listings/create"}>
              <div className="bg-gray-100 p-4 rounded-xl shadow-md min-h-40 cursor-pointer hover:brightness-90 hover:shadow-lg transition-all duration-300">
